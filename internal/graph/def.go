...
//func CreateSchemaFromYaml(yamlSpec []byte, providerRegistry *packages.Registry) (*SchemaDef, graph.Graph, error) {
...
//func CreateSchemaFromJSON(jsonSpec []byte, providerRegistry *packages.Registry) (*SchemaDef, graph.Graph, error) {
//	var schemaDef SchemaDef
...
//func createGraphDef(graphDef Def, providerRegistry *packages.Registry) (graph.Graph, error) {
